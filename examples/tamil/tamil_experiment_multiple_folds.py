...
from examples.tamil.transformer_configs import transformer_config, MODEL_TYPE, MODEL_NAME, LANGUAGE_FINETUNE, \
...
train = read_datafile('examples/tamil/data/tamil_final.tsv.txt', fix=False)
